...
export class RecursoComponent {
  ...
  listaIconos!: any[];
  iconos!:any[];
  constructor(private recursoService:RecursoService,private sistemaService:SistemaService,private localService:LocalService, private notificacionService:NotificacionService,private iconService:IconService){
  }
  ngOnInit() {
